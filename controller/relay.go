...
func relayHandler(c *gin.Context, info *relaycommon.RelayInfo) *types.FlareError {
...
func geminiRelayHandler(c *gin.Context, info *relaycommon.RelayInfo) *types.FlareError {
	var err *types.FlareError
...
func getChannel(c *gin.Context, info *relaycommon.RelayInfo, retryParam *service.RetryParam) (*model.Channel, *types.FlareError) {
...
func shouldRetry(c *gin.Context, openaiErr *types.FlareError, retryTimes int) bool {
	if openaiErr == nil {
		return false
	}
...
func processChannelError(c *gin.Context, channelError types.ChannelError, err *types.FlareError) {
