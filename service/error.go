...
func RelayErrorHandler(ctx context.Context, resp *http.Response, showBodyWhenFail bool) (newApiErr *types.FlareError) {
...
func ResetStatusCode(newApiErr *types.FlareError, statusCodeMappingStr string) {
